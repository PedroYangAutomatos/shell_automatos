...
{
       0,     0,     3,     5,     7,     9,    12,    13,    14,    20,
      22,    24,    27,    29,    31,    33,    35,    38,    40,    41,
      45,    47,    50,    51,    55,    56,    60,    62,    65,    67,
      69,    72,    74
};
...
{
      18,     0,    -1,    19,    -1,    25,    -1,    20,    -1,    20,
      16,    -1,    -1,    -1,     4,    21,     3,    22,    23,    -1,
       4,    -1,    24,    -1,    23,    24,    -1,     5,    -1,     6,
      -1,     7,    -1,    26,    -1,    26,    16,    -1,     8,    -1,
      -1,     8,    27,    28,    -1,    29,    -1,    28,    29,    -1,
      -1,    11,    30,    32,    -1,    -1,    12,    31,    34,    -1,
      10,    -1,    32,    33,    -1,    33,    -1,     9,    -1,    34,
      35,    -1,    35,    -1,     7,    -1
};
...
{
       0,    66,    66,    67,    70,    71,    73,    73,    73,    74,
      76,    77,    79,    80,    81,    85,    86,    88,    89,    89,
      91,    92,    94,    94,    95,    95,    96,    98,    99,   101,
     103,   104,   106
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DIR_INI_ATTR", "DIR_INI_ORD", "MUDA_DIR", "ID", "BARRA", "FIM",
  "$accept", "input", "ls_fim", "ls", "$@1", "$@2", "ls_params",
  "ls_param", "dir_fim", "dir", "$@3", "dir_multi_params", "dir_params",
  "$@4", "$@5", "dir_attr_params", "dir_attr_param", "dir_ord_params",
  "dir_ord_param", YY_NULL
};
#endif
...
{
       0,    17,    18,    18,    19,    19,    21,    22,    20,    20,
      23,    23,    24,    24,    24,    25,    25,    26,    27,    26,
      28,    28,    30,    29,    31,    29,    29,    32,    32,    33,
      34,    34,    35
};
...
{
       0,     9,    18,     0,     2,     4,     3,    15,     0,     0,
       1,     5,    16,     7,    26,    22,    24,    19,    20,     0,
       0,     0,    21,    12,    13,    14,     8,    10,    29,    23,
      28,    32,    25,    31,    11,    27,    30
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,     4,     5,     8,    19,    26,    27,     6,     7,
       9,    17,    18,    20,    21,    29,    30,    32,    33
};
...
{
      -3,     6,     0,    10,   -13,    -5,   -13,    -4,    11,    -8,
     -13,   -13,   -13,   -13,   -13,   -13,   -13,    -8,   -13,     1,
       4,     8,   -13,   -13,   -13,   -13,     1,   -13,   -13,     4,
     -13,   -13,     8,   -13,   -13,   -13,   -13
};
...
{
     -17,     1,    14,    15,    16,     2,    23,    24,    25,    -6,
      10,    11,    12,    28,    13,    31,   -17,    34,    35,    22,
      36
};
...
{
       0,     4,     8,    18,    19,    20,    25,    26,    21,    27,
       0,    16,    16,     3,    10,    11,    12,    28,    29,    22,
      30,    31,    29,     5,     6,     7,    23,    24,     9,    32,
      33,     7,    34,    35,    24,    33,    35
};
